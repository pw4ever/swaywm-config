...
paru -S --noconfirm --needed wdisplays wlr-randr kanshi autotiling ydotool swaync awww btop
...
paru -S --noconfirm --needed neovim neovide emacs ghostty kitty tmux ranger pcmanfm ipython rofi rofi-pass rofi-calc rofi-emoji wofi jq bashmount
...
paru -S --noconfirm --needed mpd-mpris mpv-mpris wl-mpris-idle-inhibit catt zenity wl-kbptr
paru -S --noconfirm --needed gnome-themes-extra adwaita-qt5-git adwaita-qt6-git
```
